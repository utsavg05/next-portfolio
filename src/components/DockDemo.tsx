...
//   return (
//     <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full">
//       <TooltipProvider>
...
//   ],
//   social: [
//     { name: "GitHub", url: "https://github.com/utsavg05", icon: IconBrandGithub },
//     { name: "LinkedIn", url: "https://linkedin.com/in/utsav-gupta-3443a0324e", icon: IconBrandLinkedin },
//     { name: "X", url: "https://x.com/0xdevug", icon: IconBrandX },
//     { name: "Email", url: "mailto:utsav.gp1204@gmail.com", icon: IconMail },
//   ],
// };
...
//           direction="middle"
//           className={cn(
//             "rounded-4xl relative mx-auto flex items-center px-",
