...
I run [Scribely](https://www.scribely.site/) — an AI-powered study tool that turns YouTube videos and PDFs into handwritten notes, flashcards, quizzes, and revision sheets. The product was built. The features worked. But nobody could find us on Google.
...
**[See what Scribely can do — try it free.](https://www.scribely.site/tools)**